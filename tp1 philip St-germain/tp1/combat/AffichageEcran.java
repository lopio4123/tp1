...
public class AffichageEcran {
	...
	public void afficherSeparateurDeTour() {
		// DO : Afficher un retour à la ligne, suivi d'une ligne d'astérisques, tel que
		// montré dans l'énoncé
		System.out.println("\n***************************************");
	}

	// -------------------------------------------------------------------------
	public void afficherSeparateurInfosPerso() {
		// DO : Afficher un retour à la ligne, suivi du séparateur "infos personnages",
		// tel que montré dans l'énoncé
		System.out.println("\n-----------------\n INFOS PERSONNAGES\n ----------------- ");
	}

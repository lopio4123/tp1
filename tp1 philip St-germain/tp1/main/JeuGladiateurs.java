...
public class JeuGladiateurs {
	...
	public static void main(String[] args) {
		...
		Mirmillon personnage1 = new Mirmillon("Bob le malchanceux", 15, 15, 70, 15, true); // L'initialisation du
																							// personnage doit se faire
																							// dans le constructeur
		Retiaire personnage2 = new Retiaire("Igor l'empaleur ", 25, 5, 100, 30, true); // L'initialisation du personnage
																						// doit se faire dans le
																						// constructeur
		...
		do {
			...
			personnage1.setNewIniRandomMirmillon();
